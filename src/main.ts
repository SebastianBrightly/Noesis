...
export const DEFAULT_SETTINGS: LocalLLMSettings = {
	...
	ragThreshold: 0.5,
	ragMaxResults: 10,
	graphWeightSemantic: 0.7,
	graphWeightBacklinkDistance: 0.12,
	graphWeightRecency: 0.08,
	graphWeightBookmarked: 0.06,
	graphWeightFolderProximity: 0.04,
	graphRecencyHalfLifeDays: 14,
	// Embedding defaults
